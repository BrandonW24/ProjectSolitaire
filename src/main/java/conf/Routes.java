...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        router.GET().route("/views/AcesUp/SpanishGame.flt.html").with(ApplicationController.class, "spanish");

        router.GET().route("/gameSpn").with(ApplicationController.class, "gameGetSpanish");
        router.GET().route("/gameEng").with(ApplicationController.class, "gameGetEnglish");
